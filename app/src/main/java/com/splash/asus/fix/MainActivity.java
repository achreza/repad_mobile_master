...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sound1 = sp.load(getApplicationContext(),R.raw.drum1,1);
        sound2 = sp.load(getApplicationContext(),R.raw.drum2,1);
        sound3 = sp.load(getApplicationContext(),R.raw.drum3,1);
        sound4 = sp.load(getApplicationContext(),R.raw.drum4,1);
        sound5 = sp.load(getApplicationContext(),R.raw.drum5,1);
        sound6 = sp.load(getApplicationContext(),R.raw.drum6,1);
        sound7 = sp.load(getApplicationContext(),R.raw.drum7,1);
        sound8 = sp.load(getApplicationContext(),R.raw.drum,1);
        sound9 = sp.load(getApplicationContext(),R.raw.drum9,1);
        sound10 = sp.load(getApplicationContext(),R.raw.drum10,1);
        sound11 = sp.load(getApplicationContext(),R.raw.drum11,1);
        sound12 = sp.load(getApplicationContext(),R.raw.drum12,1);
        sound13 = sp.load(getApplicationContext(),R.raw.drum13,1);
        sound14 = sp.load(getApplicationContext(),R.raw.drum14,1);
        sound15 = sp.load(getApplicationContext(),R.raw.drum15,1);
        sound16 = sp.load(getApplicationContext(),R.raw.drum16,1);
